...
class ApparelShoesPage:
    ...
    def open(self):
        # Открытие браузера
        with allure.step("Открываем страницу одежда и обувь"):
            self.browser.get(self.url)

    def check_apparel_shoes_page(self):
        with allure.step("Проверяем заголово страницы одежда и обувь"):
    ...
    def display_per_page(self):
        with allure.step("Проверяем переключение отображения кол-ва элементов странице одежда и обувь"):
            count_locator = {
    ...
    def view_as(self):
        with allure.step("Проверяем переключение отображения элементов странице одежда и обувь списком или сеткой"):
            view_locator = {
